...
const TopBar: React.FC<TopBarProps> = ({
  ...
  return (
    <div className="w-full min-w-[1200px] h-[76.78px] bg-white border-b border-[#e8e8e8] flex items-center justify-between px-[30px] box-border">
      <div className="font-roboto font-bold text-[40px] tracking-[1px] text-black">
        Dashboard
      </div>
      <div className="flex items-center gap-5">
        <div className="relative cursor-pointer">
          ...
          />
          {notificationCount > 0 && (
            <div className="absolute -top-2 -right-2 w-4 h-[17.55px] bg-[#f93c65] rounded-full flex items-center justify-center text-white text-xs font-nunito-sans font-bold">
              {notificationCount}
            </div>
          )}
        </div>
        <div className="flex items-center gap-[10px] cursor-pointer">
          <img 
            ...
            alt="language flag"
            className="w-[40px] h-[29.62px]"
          />
          <span className="font-nunito-sans font-semibold text-sm text-[#646464]">{language}</span>
          <img 
            src="https://dashboard.codeparrot.ai/api/image/Z7m9jVCHtJJZ6wBz/drop-dow.png" 
            alt="dropdown"
            className="w-[8.16px] h-[5.12px]"
          />
        </div>
        <div className="flex items-center gap-[15px] cursor-pointer">
          <img 
            ...
            alt="profile"
            className="w-11 h-[48.26px] rounded-full"
          />
          <div className="flex flex-col">
            <span className="font-roboto font-bold text-sm text-[#404040]">{userName}</span>
            <span className="font-nunito-sans font-semibold text-xs text-[#565656]">{userRole}</span>
          </div>
          <img 
            src="https://dashboard.codeparrot.ai/api/image/Z7m9jVCHtJJZ6wBz/more.png" 
            alt="more options"
            className="w-[18px] h-[19.74px]"
          />
        </div>
      </div>
    </div>

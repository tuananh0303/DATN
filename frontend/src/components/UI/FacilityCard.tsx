...
const FacilityCard: React.FC<Props> = ({ facilityName, sportIcons, startTime, endTime, location, ratingScore, quantityRating }) => {
  return (
    <div className="w-72 border-2 border-black rounded-lg flex-shrink-0">
      <img src={Image} alt="thumbnail" className='h-44 object-cover hover:scale-105 rounded-t-lg' />
      <div className='p-2 space-y-3'>
        ...
        <div className='text-xs truncate'>Địa chỉ: {location}</div>
